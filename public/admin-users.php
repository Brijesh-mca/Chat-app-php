          ...
          <?php foreach ($users as $user): ?>
            <tr>
              ...
              <td class="d-flex gap-2">
                <a href="admin-edit-user.php?id=<?= $user['unique_id'] ?>" class="btn btn-sm btn-primary" title="Edit">
                  <i class="fas fa-edit"></i>
                </a>

                <form action="../php/admin-toggle-user-block.php" method="POST" class="d-inline">
                  ...
                  <button type="submit" class="btn btn-sm <?= $user['is_blocked'] ? 'btn-success' : 'btn-warning' ?>" 
                    ...
                    <i class="fas <?= $user['is_blocked'] ? 'fa-user-check' : 'fa-user-slash' ?>"></i>
                  </button>
                </form>
