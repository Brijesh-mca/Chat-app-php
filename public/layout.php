    ...
    <div class='setting-container'>
        ...
        <div class="content-container">
            ...
            <div class="navbar" role="navigation">
                ...
                <button  onclick="window.location.href='contact-list.php'" aria-label="Contacts" class="create-group-btn">
                    <div class="nav-item <?php echo $active_page === 'contacts' ? 'active' : ''; ?>">
                        <i class="bi bi-person"></i>
                        <span class="nav-text">Contacts</span>
                    </div>
                </button>
                <button onclick="window.location.href='settings.php'" aria-label="Settings">
